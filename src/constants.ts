...
export declare const FLAGS: Readonly<{
/**
* Flag indicating if the welcome page should be enabled.
* Default: disabled (false).
*/
    readonly WELCOME_PAGE_ENABLED: 'welcomepage.enabled'
/**
 * Flag indicating if the video share button should be enabled
 * Default: enabled (true).
 */
    readonly VIDEO_SHARE_BUTTON_ENABLED: 'video-share.enabled'
/**
 * Flag indicating if the video mute button should be displayed.
 * Default: enabled (true).
 */
    readonly VIDEO_MUTE_BUTTON_ENABLED: 'video-mute.enabled'
/**
 * Flag indicating if the toolbox should be enabled
 * Default: enabled.
 */    
    readonly TOOLBOX_ENABLED: 'toolbox.enabled'
/**
 * Flag indicating if the toolbox should be always be visible
 * Default: disabled (false).
 */
    readonly TOOLBOX_ALWAYS_VISIBLE: 'toolbox.alwaysVisible'
    // readonly WELCOME_PAGE_ENABLED: 'enabled'
    // readonly WELCOME_PAGE_ENABLED: 'enabled'
    // readonly WELCOME_PAGE_ENABLED: 'enabled'
    // readonly WELCOME_PAGE_ENABLED: 'enabled'
    // readonly WELCOME_PAGE_ENABLED: 'enabled'
...
export declare type ResultMap = typeof FLAGS;
